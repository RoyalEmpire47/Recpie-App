...
public class customGridAdapterBest extends BaseAdapter {
    Context context;
    ArrayList<DummyData> data = new ArrayList<>();
    ArrayList<String> keylist = new ArrayList<>();

    public customGridAdapterBest() {
    }

    public customGridAdapterBest(Context context, ArrayList<DummyData> d, ArrayList<String> keyList) {
